...
<div class="container">
    ...
    $lastSunday = date('Ymd', strtotime('last Sunday', strtotime(date('Ymd'))));
    $lastMonday = date('Ymd', strtotime('last Monday', strtotime(date('Ymd'))));
    $nextSunday = date('Ymd', strtotime('next Sunday', strtotime(date('Ymd'))));
...
//            var_dump($row);
        ...
        <div class="week-report">
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    <th rowspan="2">
                        <?php echo date('d/m', strtotime($lastMonday)) . ' - ' . date('d/m', strtotime($nextSunday)); ?>
                    </th>
                    <th colspan="2">Mon</th>
                    <th colspan="2">Tue</th>
                    <th colspan="2">Wed</th>
